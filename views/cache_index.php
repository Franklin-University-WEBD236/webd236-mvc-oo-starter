...
<html>
  <head>
    <title><?php echo(CONFIG['applicationName']. " - " . $title); ?></title>
...
<?php  endif; ?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="display-4"><?php echo(CONFIG['applicationName']. " - " . $title); ?></h1>
          <p class="lead"><?php echo(CONFIG['leadDescription']); ?></p>
          <p><em>Author: <?php echo(CONFIG['authorName']); ?></em></p>
          <hr>
        </div>
      </div>
